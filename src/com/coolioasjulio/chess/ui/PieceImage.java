...
public class PieceImage {
    ...
    /**
     * Loads the piece image from disk and cache it in memory. If it's already
     * been loaded from disk, return from memory.
     * 
     * This operation requires a specific file system. White image files are
     * stored in a folder called, white, and the same for black. Each piece
     * image must support transparency (png) and should be 2 letters long. The
     * first letter is the color of the piece. ("w" or "b") The second letter is
     * the name of the piece. k for King, n for Knight, q for Queen, r for Rook,
     * b for Bishop, p for Pawn.
     * 
     * @param p
     *            The piece to load the image of
     * @param tileSize
